...
const Register = () => {
    ...
    const onSubmit = async (data) => {
        ...
        // Consider adding these fields back to the form if they are important
        const year = data.email.substring(0, 2); // Extract year from email
        const batch = `20${year}`; // Basic assumption for batch

        // You might need a more robust way to map branch code to department name
