...
// This component shows the list of conversations on the side
...
// This component shows the messages and the input form for the selected chat
const ChatWindow = ({ conversation }) => {
    ...
    useQuery({
        ...
        // V-- THIS IS THE FIX for the 404 error --V
        ...
        <div className="flex-grow h-full flex flex-col">
            ...
            <div className="p-4 bg-base-200 border-t border-base-300 flex-shrink-0">
                <form onSubmit={handleSendMessage} className="join w-full">
                    ...
                    <button type="submit" className="btn btn-primary join-item"><FaPaperPlane /></button>
                </form>
            </div>
        </div>
    )
